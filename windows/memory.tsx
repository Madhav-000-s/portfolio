...
const Memory = () => {
  ...
  const bestScore = highScores.memory
    ...
    <div id="memory-window">
      ...
      <div id="window-header">
        ...
        <div id="window-controls">
          <div className="minimize" onClick={() => minimizewindow("memory")} />
          <div className="maximize" />
          <div className="close" onClick={() => closewindow("memory")} />
        </div>
      </div>
