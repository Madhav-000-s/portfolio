...
import Game2048Component from "./games/Game2048"
...
const Game2048 = () => {
  ...
  const bestScore = highScores.game2048

  return (
    <div id="game2048-window">
      {/* Window Header */}
      <div id="window-header">
        <h2>2048</h2>
        <div id="window-controls">
          <div className="minimize" onClick={() => minimizewindow("game2048")} />
          <div className="maximize" />
          <div className="close" onClick={() => closewindow("game2048")} />
        </div>
      </div>
      ...
      <div className="bg-[#2b2b2b] p-4 overflow-auto flex items-center justify-center" style={{ height: "calc(100% - 100px)" }}>
        <Game2048Component
          ...
          onScoreChange={(newScore) => {
            setScore(newScore)
            setHighScore("game2048", newScore)
          }}
