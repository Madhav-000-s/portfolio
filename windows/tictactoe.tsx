...
const TicTacToe = () => {
  ...
  const bestScore = highScores.tictactoe
    ...
    <div id="tictactoe-window">
      ...
      <div id="window-header">
        ...
        <div id="window-controls">
          <div className="minimize" onClick={() => minimizewindow("tictactoe")} />
          <div className="maximize" />
          <div className="close" onClick={() => closewindow("tictactoe")} />
        </div>
      </div>
      ...
      <div className="bg-[#2b2b2b] p-4 overflow-auto flex items-center justify-center" style={{ height: "calc(100% - 100px)" }}>
        <TicTacToeGame
          ...
          onScoreChange={(newScore) => {
            setScore(newScore)
            setHighScore("tictactoe", newScore)
          }}
