...
// Size constraints for contact window
const MIN_WIDTH = 350
const MAX_WIDTH = 600
...
export default function ContactWindow() {
  const contactState = useWindowStore((state) => state.windows.contact)
  ...
  useEffect(() => {
    if (!windowRef.current || !contactState?.isOpen) return
  ...
  }, [contactState?.isOpen, focuswindow])
